...
const FilterRunTypeSportBlock = ({ title, sportType }: IProps) => {
      ...
      <div>
        ...
        <div className="w-full pb-4">
          <DoubleSlider
            ...
            minSteps={[-1, -0.8, -0.6, -0.4, -0.2, 0]}
            maxSteps={[0, 0.2, 0.4, 0.6, 0.8, 1]}
            minStep={0.2}
            maxStep={0.2}
            onChange={(values) => {
      ...
      <div>
        ...
        <div className="w-full pb-4">
          <DoubleSlider
            ...
            minSteps={[-1.5, -1.2, -0.9, -0.6, -0.3, 0]}
            maxSteps={[0, 0.3, 0.6, 0.9, 1.2, 1.5]}
            minStep={0.3}
            maxStep={0.3}
            onChange={(values) => {
              setUserFilterOffset((prevState) => ({
      ...
      <div>
        ...
        <div className="w-full pb-4">
          <DoubleSlider
            ...
            minSteps={[-10, -8, -6, -4, -2, 0]}
            maxSteps={[0, 2, 4, 6, 8, 10]}
            minStep={2}
            maxStep={2}
            onChange={(values) => {
              setUserFilterOffset((prevState) => ({
...
export default FilterRunTypeSportBlock;
