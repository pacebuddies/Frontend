...
const RecommendationsModalContent = ({ data, num, selectedSports }: IProps) => {
  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <div className="flex lg:flex-nowrap flex-wrap lg:flex-row w-full grow">
        ...
        <div className="flex-auto relative min-h-[16rem] min-w-[10rem] border border-green-500 bg-white p-8">
